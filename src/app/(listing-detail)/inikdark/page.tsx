            ...
            <div className="listingSection__wrap !space-y-6">
                ...
                <div
                    ...
                    <div className="flex items-center space-x-3 ">
                        ...
                        <span className="">
              2 <span className="hidden sm:inline-block">huespedes</span>
            </span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <i className=" las la-bed text-2xl"></i>
                        <span className=" ">
              1 <span className="hidden sm:inline-block">camas</span>
            </span>
                    </div>
                </div>
            </div>
            ...
            <div className="listingSection__wrap">
                ...
                <div className="text-neutral-6000 dark:text-neutral-300 text-justify">
                    <span className="block mb-4">
                     Disfruta de encontrar esos lugares escondidos de Gran Canaria sin tener que mirar atrás, tendrás
                        todo lo necesario para disfrutar de tus vacaciones sin preocupaciones, tenemos autonomía para
                        varios días con placas solares, enchufes para tus pequeños electrodomésticos 12v y enchufes de
                        220v para tu portátil.
                     </span>
                    <span className="block mb-4">
        ...
        return (
            <div className="listingSectionSidebar__wrap shadow-xl p-4 lg:p-6">
                ...
                <div className="flex justify-around mt-2">
                    <a href="https://www.airbnb.es/rooms/1065005349819753921?source_impression_id=p3_1717958515_P3cR-evOUz6gv4dR" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.yescapa.es/campers/57378?date_from=2024-08-05&date_to=2024-08-09&hour_from=14&hour_to=12&_gl=1*12uggbw*_up*MQ..&gclid=CjwKCAjwo6GyBhBwEiwAzQTmc1HpydgXw0xqLJIpjLcWXKN3qQJnUPest5p17loKIq4jaUFVM162uRoCni8QAvD_BwE&kilometers=100" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.camplify.es/vehiculo/alquilar-furgoneta-camper-aeropuerto-gran-canaria-inikdark/37941" target="_blank" rel="noopener noreferrer">
