            ...
            <header className="container rounded-3xl px-4 lg:px-8">
                <div className="max-w-screen-lg mx-auto space-y-5">
                    ...
                    <span className="block text-base text-neutral-500 md:text-lg dark:text-neutral-400 pb-1 text-justify">
                        ...
                        la información necesaria para aprovechar al máximo tu estancia en nuestras campers.
                        Esta guía incluye instrucciones detalladas sobre diversos aspectos del uso y cuidados de las campers.
                    </span>
                    <GuideAccordion/>
                </div>
            </header>
